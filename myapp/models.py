...
class Customercustomerdemo(models.Model):
    customerid = models.OneToOneField('Customers', models.DO_NOTHING, db_column='CustomerID', primary_key=True, null=False)  # Field name made lowercase. The composite primary key (CustomerID, CustomerTypeID) found, that is not supported. The first column is selected.
...
class Customers(models.Model):
    customerid = models.TextField(db_column='CustomerID', primary_key=True, blank=True, null=False)  # Field name made lowercase.
...
class Orders(models.Model):
    ...
    employeeid = models.ForeignKey(Employees, models.DO_NOTHING, db_column='EmployeeID', blank=False, null=False)  # Field name made lowercase.
...
class Products(models.Model):
    ...
    categoryid = models.ForeignKey(Categories, models.DO_NOTHING, db_column='CategoryID', blank=True, null=False)  # Field name made lowercase.
